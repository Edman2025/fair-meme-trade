...
contract FairMemeFactoryV2 {
    ...
    function recordTrade(address token, bool isBuy, uint256 amountIn, uint256 amountOut, uint256 feeAmount) external {
        require(projectIdByToken[token] != 0, "TOKEN_NOT_LISTED");
        emit TradeRecorded(token, msg.sender, isBuy, amountIn, amountOut, feeAmount);
    }
